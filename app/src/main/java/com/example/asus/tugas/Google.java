...
public class Google extends AppCompatActivity implements  AdapterView.OnItemSelectedListener {
        ...
        setContentView(R.layout.activity_google);
            ...
            tentang.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(Google.this, Tentang.class);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Google.this, Rincian.class);
